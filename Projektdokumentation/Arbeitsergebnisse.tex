...
\subsubsection{Funktionsweise}
Dieses Modul wird nur indirekt benutzt. Es dient als Datenhaltung für wichtige, für andere Module nötige Informationen der Personenanzahl. (//TODO: HIER NUR VERWEIS AUF BILD) (An dieser Stelle Projektdokumentation/img/Szenarien/ErkennungAnzahlPersonen.pdf verwenden?) %TODO Modell einfügen
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{
			>{\hsize=2.0\hsize}X % 40% of 3\hsize 
			>{\hsize=0.5\hsize\centering}X % 30% of 3\hsize
			>{\hsize=0.5\hsize\centering\arraybackslash}X % 40% of 3\hsize
			% sum=3.0\hsize for 3 columns
		}
		\hline
		\textbf{Event Name}						& \textbf{Parameter}	& \textbf{Beschreibung} \\
