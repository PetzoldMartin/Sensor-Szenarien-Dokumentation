...
Der folgende Abschnitt beschreibt die einzelnen Modulen, welche aus den erforderlichen Funktionalitäten der Szenarien ermittelt wurden. Zudem zeigt die Übersicht (\prettyref{fig:modulkonzeptionUebersichtAbh}) die Abhängigkeiten der Module untereinander und die, von beiden Szenarien, gemeinsam verwendeten Funktionalitäten. Der Schwerpunkt, der Modulkonzeption liegt bei der Beschreibung der Funktionalität, sowie den Schnittstellen.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{img/Modulkonzeption/ModulKonzeption.png}
	\caption{Modulkonzeption: Übersicht und Abhängigkeiten}
	\label{fig:modulkonzeptionUebersichtAbh}
\end{figure}
