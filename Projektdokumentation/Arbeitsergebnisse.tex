...
\item [TurnOffHazardModule] Nach Ablauf des \emph{Timers} wird ein Aufruf an das \emph{TurnOffHazardModule} gesendet. Dieser schaltet nun alle definierten Gefahrenquellen ab. Sollte erneut ein Erwachsener erkannt werden können, sofern gewünscht, die Gefahrenquellen erneut aktiviert werden.
\end{description}
...
\item [Sensoair CO$_2$ Sensor und Aeotec Bewegungssensor] Zur Personenidentifikation wird zum einen der Aeotec Bewegungssensor verwendet um einen Erwachsenen zu erkennen, sollte dieser aktiviert werden. Zum anderen wird der CO$_2$ Sensor benutzt um die Erkennung des Bewegungssensors zu überprüfen.
